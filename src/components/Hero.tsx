  ...
  return (
    <section className="relative min-h-screen flex items-center gradient-hero overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        {/* Geometric shapes */}
        <FloatingElement delay={0} className="absolute top-20 left-10 w-20 h-20 border border-white/10 rounded-lg rotate-12">
          <div className="w-full h-full bg-gradient-to-br from-white/5 to-transparent rounded-lg"></div>
        </FloatingElement>
        
        <FloatingElement delay={2} className="absolute bottom-32 right-20 w-16 h-16 border border-white/10 rounded-full">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className={`text-white transition-all duration-1000 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
            {/* Animated badge */}
            <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm rounded-full px-4 py-2 mb-6 border border-white/20 hover-scale">
              <Award className="h-4 w-4 text-yellow-400" />
              <span className="text-sm font-medium">Licensed RCIC • 20+ Years Experience</span>
            </div>

            {/* Premium typography with gradient */}
            <h1 className="text-5xl lg:text-7xl font-poppins font-bold leading-tight mb-6">
              <span className="bg-gradient-to-r from-white via-white to-white/80 bg-clip-text text-transparent">
                Honest Advice
              </span>
              <br />
              <span className="text-4xl lg:text-6xl bg-gradient-to-r from-white/90 to-white/70 bg-clip-text text-transparent">
                For All Your
              </span>
              <br />
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
              <div className="text-center p-4 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10 hover-scale">
            ...
            <div className="flex flex-wrap items-center gap-6 mb-8">
              {[
                ...
                <div 
                  key={index}
                  className={`flex items-center gap-2 transition-all duration-300 hover-scale ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-8">
              <a href="/contact" className="group">
                <Button 
                  size="lg" 
                  className="w-full sm:w-auto bg-white text-canada-red hover:bg-white/90 shadow-xl font-semibold px-8 py-4 text-lg transition-all duration-300 hover:shadow-2xl hover:scale-105 group-hover:animate-pulse"
                >
              ...
              <a href="https://wa.me/16047254814?text=Hi, I'm interested in your immigration services." className="group">
                <Button 
                  size="lg" 
                  variant="outline" 
                  className="w-full sm:w-auto border-2 border-white text-white hover:bg-white hover:text-canada-red font-semibold px-8 py-4 text-lg transition-all duration-300 hover:shadow-xl hover:scale-105 backdrop-blur-sm bg-white/10"
                >
            ...
            <div className="p-6 bg-white/5 backdrop-blur-sm rounded-xl border border-white/10">
              ...
              <div className="mt-3 text-xs text-white/70">
                🏆 Licensed RCIC | 🇨🇦 CICC Member | 📞 Free Initial Consultation
              </div>
            </div>
          </div>
